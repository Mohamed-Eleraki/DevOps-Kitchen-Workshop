...
The community is open-source which means any one have the ability to append workshops, provide online sessions, Get Admin privilege to groups (Slack, LinkedIn, and WhatsApp) However, To get the admin rule you should show our your dedication!
...
- Check each workshop details on Slack Or GitHub as well (i.e. Check Slack `devops-kitchen-workshop` channel canvas)
- Follow-up each workshop details and submit it via the `devops-kitchen-workshop` slack channel.
...
- Start learning services, a Service per week, and the end of the week crafting a workshop.
...
- Delivering the tasks result should be in slack Channel.<br><br>
